    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            user_data = json.dumps({
                "username": "cocomittens"
            })

            session_data = requests.get("http://localhost:8000/api/session/", headers={"Content-Type": "application/json"}, data=user_data)
            print(session_data.json()) 

            headers = {"User-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36",
                        "Origin": "https://leetcode.com", "Referer": "https://leetcode.com/", 
                        "Host": "leetcode.com", "X-CSRFToken": "ImcTrpOKcjyN6G7d5OVrsFrC4hDOonFpYDktN4AuivJI1YHoModQlsHZVhoAk5B9", 
